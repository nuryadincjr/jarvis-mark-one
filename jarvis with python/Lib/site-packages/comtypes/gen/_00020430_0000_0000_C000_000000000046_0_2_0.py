...
IFontDisp = Font
__all__ = [ 'FontEvents', 'OLE_XSIZE_PIXELS', 'IPicture',
           'OLE_XSIZE_CONTAINER', 'FONTSTRIKETHROUGH', 'Picture',
           'FONTUNDERSCORE', 'FONTBOLD', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_TRISTATE', 'StdPicture', 'IFont', 'OLE_XPOS_HIMETRIC',
           'Unchecked', 'Default', 'FONTITALIC', 'IPictureDisp',
           'FONTNAME', 'OLE_HANDLE', 'Font', 'OLE_YPOS_CONTAINER',
           'Color', 'OLE_YSIZE_HIMETRIC', 'Gray',
           'LoadPictureConstants', 'IFontDisp', 'Monochrome',
           'OLE_YSIZE_CONTAINER', 'OLE_CANCELBOOL',
           'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS', 'VgaColor',
           'OLE_XPOS_CONTAINER', 'OLE_YPOS_HIMETRIC', 'Checked',
           'IFontEventsDisp', 'OLE_YPOS_PIXELS', 'StdFont',
           'OLE_OPTEXCLUSIVE', 'OLE_XPOS_PIXELS', 'OLE_COLOR',
           'FONTSIZE']
